...
if __name__ == '__main__':
    """
    this setting fits in side camera
    images test/00.jpg, test/01.jpg, test/02.jpg
    """
    path = 'test'
    ...
    show_image = False
    digits = read_digits(gray, image, skew=9, avg_digit_width=16, brightness=70, debug=show_image)
    # assert number -1
    if -1 in digits:
